              ...
              <form ref={formRef} className="space-y-8" onSubmit={handleSubmit}>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      name="name"
                      required
                      className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 text-slate-900 focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-all font-light"
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    required
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 text-slate-900 focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-all font-light resize-none"
