...
export default function ContactsPage() {
  ...
  // Функция, която прихваща името на качения файл, за да го покаже на потребителя
          ...
          <div className="grid lg:grid-cols-5 gap-16 md:gap-24 items-start">
            ...
            <div className="lg:col-span-3 bg-white rounded-[40px] p-8 md:p-14 shadow-2xl border border-slate-100">
              ...
              <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                ...
                {/* Качване на файл (Проект за оферта) */}
                <div className="space-y-2">
                ...
                <button 
                  type="submit"
                  className="w-full bg-slate-900 text-white py-5 rounded-2xl text-[11px] font-bold tracking-[0.2em] uppercase hover:bg-teal-700 transition-colors shadow-lg mt-4"
                >
                  Изпрати запитване
                </button>
